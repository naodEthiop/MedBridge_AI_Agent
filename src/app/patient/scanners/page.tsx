...
export default function ScannersPage() {
  return (
    <AppShell title="Medication scanner" subtitle="Prescription image · Gemini analysis">
      <div className="mx-auto max-w-3xl space-y-8">
        <header>
          ...
          <p className="mt-4 max-w-2xl text-lg text-sahara-muted">
            Capture or upload a prescription label. Results from the Gemini-powered API appear in the response panel below.
          </p>
        </header>
